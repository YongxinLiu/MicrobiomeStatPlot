...
![](http://210.75.224.110/github/MicrobiomeStatPlot/211AlphaBoxplot/alpha_diversity_Qian2020CMJ.jpg)
...
![](http://210.75.224.110/github/MicrobiomeStatPlot/211AlphaBoxplot/boxprinciple1.png)

**图2. 以Alpha多样性最常用的香农指数(Shannon index)为例**

- 第二种情况：最大或最小值超过1.5倍箱体范围，外位延长线外，即异常值(outliers)：

![](http://210.75.224.110/github/MicrobiomeStatPlot/211AlphaBoxplot/boxprinciple2.png)
...
![](http://210.75.224.110/github/MicrobiomeStatPlot/211AlphaBoxplot/2019NBT.fig1e.png)
...
![](http://210.75.224.110/github/MicrobiomeStatPlot/211AlphaBoxplot/2020GutMicrobes.fig1hij.png)
...
![](http://210.75.224.110/github/MicrobiomeStatPlot/211AlphaBoxplot/2020GutMicrobes.fig1bc.png)
...
![](http://210.75.224.110/github/MicrobiomeStatPlot/211AlphaBoxplot/7.png)
...
```
![](http://210.75.224.110/github/MicrobiomeStatPlot/211AlphaBoxplot/8.png)
...
![](http://210.75.224.110/github/MicrobiomeStatPlot/211AlphaBoxplot/9.png)
...
![](http://210.75.224.110/github/MicrobiomeStatPlot/211AlphaBoxplot/10.png)
...
ggsave(paste0("10.png"), p, width=89, height=56, units="mm")
```
![](http://210.75.224.110/github/MicrobiomeStatPlot/211AlphaBoxplot/11.png)
