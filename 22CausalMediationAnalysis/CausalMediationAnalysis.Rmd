...
# 1. Total effect: The total impact of the independent variable on the dependent variable
fit_total_effect <- lm(dv ~ Sepal.Length, df)
summary(fit_total_effect)

# 2. Impact of independent variable on mediator
# The independent variable must significantly influence the mediator
fit_mediator <- lm(mediator ~ Sepal.Length, df)
summary(fit_mediator)

# 3. Influence of mediator on dependent variable
# The mediator must better explain the variance of the dependent variable than the independent variable
fit_dv <- lm(dv ~ Sepal.Length + mediator, df)
summary(fit_dv)

# 4. Causal mediation analysis
# Using the mediation package to estimate the entire mediation
# install.packages("mediation")
library(mediation)
results <- mediate(fit_mediator, fit_dv, treat = 'Sepal.Length', mediator = 'mediator', boot = TRUE)
summary(results)
...
# Total Effect: Total effect of IV on DV (direct + indirect)
# Prop. Mediated: Proportion of the total effect of IV on DV mediated by the mediator
